...
const SupervisorLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: "My Groups", href: "/supervisor/groups", icon: Users },
    { name: "Submissions", href: "/supervisor/submissions", icon: FileText },
    { name: "Meetings & Logs", href: "/supervisor/meetings", icon: Calendar },
    { name: "Form-D Endorsement", href: "/supervisor/form-d", icon: FileText },
    { name: "Grading", href: "/supervisor/grading", icon: Award },
    { name: "Announcements", href: "/supervisor/notifications", icon: Bell },
  ...
  return (
    <div className="min-h-screen bg-orange-50/30 font-sans">
      ...
      {/* Sidebar - Orange/Amber Theme for Supervisor */}
      <aside
        ...
        className={`
          fixed top-0 left-0 z-50 h-screen bg-gradient-to-b from-amber-800 to-orange-900
      ...
      >
        ...
        <div
          className={`
          h-20 flex items-center border-b border-amber-700/50
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-amber-300 text-xs">Supervisor Panel</p>
            </div>
          </Link>

          <button
            onClick={() => setMobileMenuOpen(false)}
            className="md:hidden ml-auto p-2 text-amber-300 hover:text-white"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Logout Section */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-amber-700/50 bg-orange-900/50">
          <button
            onClick={handleLogout}
            title="Sign Out"
            className={`
              flex items-center w-full px-3 py-3 text-amber-300 
      ...
      >
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-gray-200">
          <div className="h-full px-8 flex items-center justify-between">
            {/* Search */}
            <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-2.5 w-72 border border-gray-100 focus-within:border-amber-500/50 focus-within:ring-2 focus-within:ring-amber-500/20 transition-all">
            ...
            <div className="flex items-center gap-4">
              <RoleSwitcher />
              <RoleNotificationPanel role="Supervisor" accentColor="amber" />
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="text-left hidden lg:block">
                    ...
                    <p className="text-xs text-amber-600 mt-1 leading-none">
                      Supervisor
                    </p>
                  </div>
                  <ChevronDown
                    ...
                    <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-20">
                      <div className="px-4 py-3 border-b border-gray-50">
                        ...
                        <p className="text-xs text-gray-500 truncate">
                          {user.email || "supervisor@university.edu"}
                        </p>
                      </div>
                      <div className="p-1">
                        <Link
