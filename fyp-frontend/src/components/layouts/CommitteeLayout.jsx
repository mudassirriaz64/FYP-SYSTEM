...
const CommitteeLayout = ({ children }) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/committee/dashboard", icon: LayoutDashboard },
    { name: "Evaluate", href: "/committee/evaluate", icon: FileText },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 font-sans">
      ...
      {/* Sidebar - Deep Blue/Slate Theme for Committee */}
      <aside
        ...
        className={`
          fixed top-0 left-0 z-50 h-screen bg-gradient-to-b from-slate-800 to-gray-900
      ...
      >
        ...
        <div
          className={`
          h-20 flex items-center border-b border-slate-700/50
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 text-xs">Committee Panel</p>
            </div>
          </Link>
      ...
      >
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-gray-200">
          <div className="h-full px-8 flex items-center justify-between">
            {/* Search */}
            <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-2.5 w-72 border border-gray-100 focus-within:border-blue-500/50 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
            ...
            <div className="flex items-center gap-4">
              <RoleSwitcher />
              {/* Using Evaluator/generic role for notification panel for now since Committee is new */}
              <RoleNotificationPanel role="Committee" accentColor="blue" />
                ...
                >
                  ...
                  <div className="text-left hidden lg:block">
                    <p className="text-sm font-semibold text-gray-900 leading-none">
                      {user.fullName || "Committee"}
                    </p>
                    <p className="text-xs text-blue-600 mt-1 leading-none">
                      Shared Access
                    </p>
                  </div>
                  <ChevronDown
                    ...
                    <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-20">
                      <div className="px-4 py-3 border-b border-gray-50">
                        <p className="text-sm font-semibold text-gray-900">
                          {user.fullName || "Proposal Committee"}
                        </p>
