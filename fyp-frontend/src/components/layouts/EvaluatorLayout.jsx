...
const EvaluatorLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    {
      name: "Assigned Defenses",
      href: "/evaluator/defenses",
      icon: ClipboardList,
    },
    { name: "Submit Marks", href: "/evaluator/marks", icon: Award },
    { name: "Announcements", href: "/evaluator/notifications", icon: Bell },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 font-sans">
      ...
      {/* Sidebar - Slate/Zinc Theme for Committee/Evaluator */}
      <aside
        ...
        className={`
          fixed top-0 left-0 z-50 h-screen bg-gradient-to-b from-slate-700 to-zinc-800
      ...
      >
        ...
        <div
          className={`
          h-20 flex items-center border-b border-violet-700/50
        ...
        >
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-violet-400 to-purple-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-violet-500/30">
            ...
            >
              ...
              <p className="text-violet-300 text-xs">Committee Panel</p>
            </div>
          </Link>

          <button
            onClick={() => setMobileMenuOpen(false)}
            className="md:hidden ml-auto p-2 text-violet-300 hover:text-white"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${
                    active
                      ? "bg-gradient-to-r from-violet-500 to-purple-500 text-white shadow-md shadow-violet-900/30"
        ...
        {/* Logout Section */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-violet-700/50 bg-purple-900/50">
          <button
            onClick={handleLogout}
            title="Sign Out"
            className={`
              flex items-center w-full px-3 py-3 text-violet-300 
      ...
      >
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-gray-200">
          <div className="h-full px-8 flex items-center justify-between">
            {/* Search */}
            <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-2.5 w-72 border border-gray-100 focus-within:border-violet-500/50 focus-within:ring-2 focus-within:ring-violet-500/20 transition-all">
              <Search className="w-4 h-4 text-gray-400 flex-shrink-0" />
              <input
                type="text"
                placeholder="Search defenses, students..."
            ...
            <div className="flex items-center gap-4">
              <RoleSwitcher />
              <RoleNotificationPanel role="Evaluator" accentColor="slate" />
                ...
                >
                  ...
                  <div className="text-left hidden lg:block">
                    <p className="text-sm font-semibold text-gray-900 leading-none">
                      {user.fullName || "Committee Member"}
                    </p>
                    <p className="text-xs text-violet-600 mt-1 leading-none">
                      Committee
                    </p>
                  </div>
                  <ChevronDown
                    ...
                    <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-20">
                      <div className="px-4 py-3 border-b border-gray-50">
                        ...
                        <p className="text-xs text-gray-500 truncate">
                          {user.email || "evaluator@university.edu"}
                        </p>
                      </div>
                      <div className="p-1">
                        <Link
